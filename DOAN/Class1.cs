...
namespace AES_File
{
    public class AES
    {
        ...
        public void FileEncrypt(string inputFile, string password)
        {
            ...
            FileStream fsCrypt = new FileStream(inputFile + "Mahoathanhcong.txt", FileMode.Create);
        ...
        public void FileDecrypt(string inputFile, string outputFile, string password)
        {
            ...
            FileStream fsOut = new FileStream(outputFile + "giaimathanhcong.txt", FileMode.Create);
